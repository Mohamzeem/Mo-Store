...
mixin _$LoginState<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(LoginResponseBody loginResponseBody) success,
  }) =>
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(LoginResponseBody loginResponseBody)? success,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
class _$SuccessImpl<T> implements Success<T> {
  const _$SuccessImpl(this.loginResponseBody);
  ...
  @override
  String toString() {
    return 'LoginState<$T>.success(loginResponseBody: $loginResponseBody)';
  }
  ...
  TResult when<TResult extends Object?>({
    ...
    return success(loginResponseBody);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return success?.call(loginResponseBody);
  }
...
abstract class Success<T> implements LoginState<T> {
  const factory Success(final LoginResponseBody loginResponseBody) =
      _$SuccessImpl<T>;
